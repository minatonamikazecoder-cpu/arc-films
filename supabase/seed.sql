...
-- 3. SERVICES (6 rows)
INSERT INTO services (title, slug, short_description, long_description, icon_svg, category_label, includes, preview_media_type, preview_media_url, sort_order, is_active) VALUES
  ('Video Production', 'video-production',
   ...
   'video', 'https://res.cloudinary.com/dkodvlw5s/video/upload/v1737427524/video_pwazu4.mp4',
   1, true),
  ...
  ('Motion Graphics', 'motion-graphics',
   ...
   'video', 'https://res.cloudinary.com/dkodvlw5s/video/upload/v1737427499/reel_qfz921.mp4',
   2, true),
  ...
  ('Logo Design', 'logo-design',
   ...
   'image', 'https://res.cloudinary.com/dkodvlw5s/image/upload/v1737427617/1_gipsva.png',
   3, true),
  ...
  ('Brand Identity', 'brand-identity',
   ...
   'image', 'https://res.cloudinary.com/dkodvlw5s/image/upload/v1737427591/1_ullhqs.png',
   4, true),
  ...
  ('3D Animation', '3d-animation',
   ...
   'video', 'https://res.cloudinary.com/dkodvlw5s/video/upload/v1737514508/3d_scene_1_2_zpi58f.mp4',
   5, true),
  ...
  ('Thumbnail Design', 'thumbnail-design',
   ...
   'image', 'https://res.cloudinary.com/dkodvlw5s/image/upload/v1737512064/Thumbnail_1_f7zjxd.png',
   6, true);
